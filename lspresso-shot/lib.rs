...
use lsp_types::{
    request::{GotoDeclarationResponse, GotoImplementationResponse, GotoTypeDefinitionResponse}, CallHierarchyIncomingCall, CallHierarchyItem, CallHierarchyOutgoingCall, CodeLens, CompletionItem, Diagnostic, DocumentDiagnosticReport, DocumentHighlight, DocumentLink, DocumentSymbolResponse, FoldingRange, FormattingOptions, GotoDefinitionResponse, Hover, Location, Moniker, Position, Range, SelectionRange, SemanticTokens, SemanticTokensDelta, SemanticTokensFullDeltaResult, SemanticTokensPartialResult, SemanticTokensRangeResult, SemanticTokensResult, TextEdit, WorkspaceDiagnosticReport, WorkspaceEdit
};
...
use types::{
    ...
    diagnostic::{DiagnosticMismatchError, PublishDiagnosticsMismatchError, WorkspaceDiagnosticMismatchError},
